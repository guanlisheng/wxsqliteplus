...
public:
    ...
    bool GetSavePerspective() {
        return m_SavePerspective;
    }

    wxString GetStyleFontName() {
        return m_FontName;
    }
    int      GetStyleFontSize() {
        return m_FontSize;
    }
    bool     GetEdgeLineVisible() {
        return m_EdgeLineVisible;
    }
    ...
    int      GetStyleTabWidth() {
        return m_StyleTabWidth;
    }
    bool     GetStyleUseTab() {
        return m_StyleUseTab;
    }
    bool     GetStyleTabIndent() {
        return m_StyleTabIndent;
    }
    bool     GetStyleBackspaceUnindent() {
        return m_StyleBackspaceUnindent;
    }
    int      GetStyleIndentWidth() {
        return m_StyleIndentWidth;
    }
    bool     GetStyleShowLineNumber() {
        return m_StyleShowLineNumber;
    }
    wxColour GetForeLineNumber() {
        return m_ForeLineNumber;
    }
    wxColour GetBackLineNumber() {
        return m_BackLineNumber;
    }
