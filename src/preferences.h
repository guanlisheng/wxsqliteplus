...
public:
    ...
    wxString GetValOddColour() const {
        return m_Val_OddColour;
    }
    void SetValOddColour(wxString value) {
        m_Val_OddColour = value;
    }

    int GetValMaxHistory() const {
        return m_Val_MaxHistory;
    }
    void SetValMaxHistory(int value) {
        m_Val_MaxHistory = value;
    }

    bool GetValSavePos() const {
        return m_Val_SavePos;
    }
    void SetValSavePos(bool value) {
        m_Val_SavePos = value;
    }

    bool GetValSavePers() const {
        return m_Val_SavePers;
    }
    void SetValSavePers(bool value) {
        m_Val_SavePers = value;
    }

    bool GetValShowEdge() const {
        return m_Val_ShowEdge;
    }
    void SetValShowEdge(bool value) {
        m_Val_ShowEdge = value;
    }

    bool GetValShowLineNumber() const {
        return m_Val_ShowLineNumber;
    }
    void SetValShowLineNumber(bool value) {
        m_Val_ShowLineNumber = value;
    }

    wxString GetValLineFG() const {
        return m_Val_LineFG;
    }
    void SetValLineFG(wxString value) {
        m_Val_LineFG = value;
    }

    wxString GetValLineBG() const {
        return m_Val_LineBG;
    }
    void SetValLineBG(wxString value) {
        m_Val_LineBG = value;
    }

    bool GetValUseTab() const {
        return m_Val_UseTab;
    }
    void SetValUseTab(bool value) {
        m_Val_UseTab = value;
    }

    bool GetValTabIndent() const {
        return m_Val_TabIndent;
    }
    void SetValTabIndent(bool value) {
        m_Val_TabIndent = value;
    }

    bool GetValBackUnindent() const {
        return m_Val_BackUnindent;
    }
    void SetValBackUnindent(bool value) {
        m_Val_BackUnindent = value;
    }

    int GetValTabWidth() const {
        return m_Val_TabWidth;
    }
    void SetValTabWidth(int value) {
        m_Val_TabWidth = value;
    }

    int GetValIndentWidth() const {
        return m_Val_IndentWidth;
    }
    void SetValIndentWidth(int value) {
        m_Val_IndentWidth = value;
    }

    wxString GetValFontName() const {
        return m_Val_FontName;
    }
    void SetValFontName(wxString value) {
        m_Val_FontName = value;
    }

    int GetValFontSize() const {
        return m_Val_FontSize;
    }
    void SetValFontSize(int value) {
        m_Val_FontSize = value;
    }
